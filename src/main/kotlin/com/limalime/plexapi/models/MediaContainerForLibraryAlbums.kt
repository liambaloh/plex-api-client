...
data class MediaContainerForLibraryAlbums(
    ...
    @JacksonXmlProperty(localName = "mixedParents", isAttribute = true) val mixedParents: Int? = null,
    ...
    @JacksonXmlProperty(localName = "Directory") val directory: List<DirectoryForLibraryAlbums> = emptyList()
)